...
## my pose -> amcl_pose
    ...
    def callback(self,event):
        ...
        goal_xy = [[15.0 , 17.0],[2.0  ,20.0],[-20.0 , 10],[-20.0 , -5.0],[-20.0 ,-20.0],[-20.0 ,-30.0],[15.0 ,-15.0]]
        ...
        distance = ((self.current_x - goal_xy[self.count][0])**2 +abs(self.current_y - goal_xy[self.count][1]))**0.5
